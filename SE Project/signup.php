...
<body>
    <form method="post" onsubmit="myaction.collect_data(event,'signup')">
        <div class="col-md-8 col-lg-4 border rounded mx-auto mt-5 p-4 shadow">
            ...
            <div class="input-group mt-3">
                <input name="name" type="text" class="form-control p-2" placeholder="Name">
            </div>
            <div><small class="js-error js-error-name text-danger"></small></div>
            <div class="input-group mt-3">
            ...
            <div class="input-group mt-3 mb-3">
                <input name="confirm_password" type="password" class="form-control p-2" placeholder="Confirm Password">
            </div>
            <div class="progress mb-3 d-none" role="progressbar">
